...
public final class RobotConstants {
    ...
    public static final double kMaxSpeed = 5.5;// 4.5 meters per second desired top speed
    public static final double kMaxAngularRate = 1.3 * Math.PI; // 3/4 of a rotation per second max angular velocity

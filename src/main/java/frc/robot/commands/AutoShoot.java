...
public class AutoShoot extends SequentialCommandGroup {
  ...
  public AutoShoot(ShooterSubsystem shooterSubsystem, ShooterWrist shooterWrist, IntakeSubsystem intakeSubsystem) {
    addCommands(
      
      new RunShooterWristToSetpoint(shooterWrist, 0.13).withTimeout(3),

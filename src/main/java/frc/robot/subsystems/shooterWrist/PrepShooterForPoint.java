...
public class PrepShooterForPoint extends Command {
  ...
  public PrepShooterForPoint(CommandSwerveDrivetrain drivetrain, ShooterWrist shooterWrist, Translation2d point) {
